...
${z390_bin}/zc390.sh $projectname 'SYSCPY(+zcobol+zcobol\z390)' $@ || \
	onerror 2 "see errors on mz390 generated bal file and console"

${z390_bin}/mz390.sh $projectname '@zcobol\z390\ZC390CLG' $@ || \
	onerror 3 "see errors on mz390 generated bal file and console"

${z390_bin}/lz390.sh $projectname 'SYSOBJ(+zcobol\z390)' $@ || \
